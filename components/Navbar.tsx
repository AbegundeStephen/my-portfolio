    ...
    <div className="max-width-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
       <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.5}}>
        ...
        <div className='hidden mdl:inline-flex items-center gap-7'>
          <ul className='flex text-{13px} gap-7'>
            <Link href="#home" className='flex items-center gap-1 font-medium text-textDark
                hover:text-textGreen cursor-pointer duration-300 nav-link' onClick={handleScroll}>
           ...
           <motion.button
            className='px-4 py-2 rounded-md text-textDark text-{13px}  border-2 border-violet-700 hover:bg-hoverColor duration-300 uppercase'
              initial={{opacity:0}}
              animate={{opacity:1}} 
        ...
        <div onClick={() => setShowmenu(!showMenu)} className="w-6 h-5 flex flex-col justify-between items-center mdl:hidden text-4xl text-textGreen cursor-pointer overflow-hidden group">
          <span className='w-full h-[2px] bg-textGreen inline-flex trasnform
         ...
         {showMenu && (
          <div onClick={handleClick}
           ...
           <div className='flex flex-col items-center gap-7'>
            ...
            <a href="/assets/ABEGUNDE.pdf" target='_blank'>
           <motion.button
            className='px-4 py-2 rounded-md text-textGreen text-{13px}  border border-textGreen hover:bg-hoverColor duration-300 uppercase'
              initial={{opacity:0}}
              animate={{opacity:1}} 
              transition={{duration:0.5}}>
                Resume
        ...
        items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all
        duration-300'
        href="" target='_blank'>
         <TbBrandGithub/>
        </motion.a>
