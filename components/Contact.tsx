  ...
  return (
    ...
    className='max-w-container max-auto py-10 xl:py-32
     flex flex-col gap-4 items-center justify-center'>
       <p className='font-titleFont text-lg text-green-500 font-semibold flex 
       itemss-center tracking-wide'>Thinking of what{"'"}s next?</p>
       ...
       provide guidance, or answer any questions you may have. Feel free to reach
        out to me by tapping my direct social links below.
